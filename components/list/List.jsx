  ...
  return (
      <div className="bg-sky-100 shadow-xl rounded-lg mb-4 p-4 sm:p-6 h-[625px] md:w-[400px]">
          <div className="flex items-center justify-between font-syne mb-4">
            ...
            <span onClick={onEdit} className="cursor-pointer hover:text-red-600 ">Edit Team</span>
            <span onClick={onDelete} className="hover:text-red-600 cursor-pointer"><GiTrashCan size={25}/></span>
          </div>
